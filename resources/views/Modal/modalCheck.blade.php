<div class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true" id="check">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required id="D_delivery" type="date" name="D_Delivery" class="form-control" placeholder="Antre dat koli a livre">
                                            </div>
